...
public final class ReferenceIcon extends View {
    ...
    private void box(Canvas c,float a,float b,float x,float y,float r){c.drawRoundRect(new RectF(a,b,x,y),r,r,paint);}
    @Override protected void onDraw(Canvas c) {
        ...
        switch(name){
            case "home": case "objects":
                Path roof=new Path();roof.moveTo(3,11);roof.lineTo(12,3);roof.lineTo(21,11);c.drawPath(roof,paint);
            ...
            case "bell":
                Path bell=new Path();bell.moveTo(5,17);bell.lineTo(6,15);bell.lineTo(6,10);bell.cubicTo(6,2,18,2,18,10);bell.lineTo(18,15);bell.lineTo(20,18);bell.lineTo(4,18);c.drawPath(bell,paint);
                c.drawArc(new RectF(9,18,15,23),0,180,false,paint);line(c,12,2,12,4);break;
            case "profile": case "engineer":
                c.drawCircle(12,7,4,paint);c.drawArc(new RectF(3,12,21,27),180,180,false,paint);line(c,3,20,21,20);break;
            case "people":
                c.drawCircle(8,7,3,paint);c.drawCircle(17,8,2.5f,paint);
                c.drawArc(new RectF(2,12,14,26),180,180,false,paint);c.drawArc(new RectF(12,13,23,26),210,140,false,paint);break;
            case "helmet":
                c.drawArc(new RectF(4,5,20,23),180,180,false,paint);box(c,2,15,22,19,2);line(c,9,5,9,12);line(c,15,5,15,12);break;
            case "chart":
                paint.setStyle(Paint.Style.FILL);box(c,3,13,7,21,1);box(c,10,8,14,21,1);box(c,17,3,21,21,1);break;
            case "money":
                c.drawOval(new RectF(4,3,20,9),paint);c.drawArc(new RectF(4,7,20,13),0,180,false,paint);
                c.drawArc(new RectF(4,11,20,17),0,180,false,paint);c.drawArc(new RectF(4,15,20,21),0,180,false,paint);
